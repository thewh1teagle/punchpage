...
Cookies work through a jar kept by the host, not by the browser: all viewers of a session share that jar, and cookies written by page JavaScript are not sent back to the host.
